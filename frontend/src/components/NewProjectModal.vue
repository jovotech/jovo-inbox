...
export type CreateProjectModel = Pick<Project, 'id' | 'name'>;

@Component({
  components: {},
})
export default class NewProjectModal extends mixins(BaseMixin, ModalMixin) {
  @Prop({ type: Boolean, default: false }) show!: boolean;

  model: CreateProjectModel = this.resetModel();
