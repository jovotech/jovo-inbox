...
// }
//
// export class DynamoDbInbox implements JovoInboxDb {
...
//     this.errorHandling();
//
//     const partitionKey = inboxLog.appId;
//     const sortKey = `${inboxLog.userId}#${inboxLog.sessionId}#${
//       inboxLog.requestId
//     }#${new Date().getTime()}`;
//
